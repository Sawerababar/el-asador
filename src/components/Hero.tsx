        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <p className="text-lg sm:text-xl text-[#D8CFBF] max-w-2xl font-normal leading-relaxed mb-8">
              At <strong className="text-white font-semibold">El Asador</strong>, we cook over glowing Texas mesquite wood embers. Experience prime carne asada, thick-cut tomahawk pork chops, house-simmered charro beans, and artisan margarita flights served in the heart of East Austin.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full pt-6 border-t border-[#2F2823]">
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#A89C8E] mt-0.5">Texas Mesquite Coals</span>
              </div>
              <div className="flex flex-col">
                <span className="font-serif text-2xl font-bold text-white">Daily</span>
                <span className="text-xs text-[#A89C8E] mt-0.5">Handmade Tortillas</span>
              </div>
              <div className="flex flex-col">
                <span className="font-serif text-2xl font-bold text-[#D9822B]">12-Hour</span>
                <span className="text-xs text-[#A89C8E] mt-0.5">Simmered Charro Beans</span>
              </div>
              <div className="flex flex-col">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-[#3A3029] bg-[#221C18] shadow-2xl p-2 sm:p-3">
              <div className="relative rounded-xl overflow-hidden aspect-[4/3] sm:aspect-[16/11]">
                <img
                  ...
                  alt="Mesquite-grilled tomahawk pork chop with charred chiles and scallions"
                ...
                <div className="absolute bottom-3 left-3 right-3 bg-[#171412]/95 backdrop-blur-md p-4 rounded-xl border border-[#3A3029]">
                  <div className="flex justify-between items-start mb-1">
                    <div>
                      <h2 className="font-serif text-lg font-bold text-white">Tomahawk Pork Chop al Mezquite</h2>
                      <p className="text-xs text-[#B5A89C]">Slow-charred over mesquite, served with charro beans & hot tortillas</p>
                    </div>
                    <span className="font-serif text-lg font-bold text-[#D9822B]">$32</span>
                  </div>
                  <div className="flex items-center gap-2 mt-2 pt-2 border-t border-[#2C241E] text-[11px] text-[#A89C8E]">
                    ...
                    <span>Free homemade charro beans with every entrée</span>
                  </div>
                </div>
              </div>
            </div>
